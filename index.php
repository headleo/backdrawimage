...
<head>
    ...
    <title>Draw Idea - Sistema de login janela modal</title>
</head>
...
<CENter><a href="https://cosmic-sunburst-71b161.netlify.app/" target="_blank" style="color: white">acessar o quadro canvas</a></CENter>
    ...
    <div class="container text-center">
        ...
        if(isset($_SESSION['id']) and (isset($_SESSION['nome']))){
            ...
            echo "<a href='teste3.php'style='color: white'>Listar Imagens</a><br>";
            echo "<a href='sair.php'style='color: white'>Sair</a><br>";
            
        }else{
            echo "<div id='dados-usuario'>";
            echo "<button type='button' class='btn btn-outline-primary m-3' data-bs-toggle='modal' data-bs-target='#loginModal'>Logar</button>";
